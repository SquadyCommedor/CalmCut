...
import type { AvatarGender, HairColorId } from '../components/CartoonAvatar';

type Stage = 'story' | 'game' | 'reward';

// Read avatar prefs saved from CharacterPage
...
export default function StoryGamePage() {
  ...
  const avatarPrefs = loadAvatarPrefs();
    ...
    <div className="min-h-screen bg-bg">
      ...
      <AnimatePresence mode="wait">
        {stage === 'story' && (
          ...
          >
            <AnimatedStory
              gender={avatarPrefs.gender}
              hairColor={avatarPrefs.hairColor}
              characterName={user ? (profile?.name ?? '') : ''}
